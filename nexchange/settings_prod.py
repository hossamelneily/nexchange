...
PAIR_CACHE_LIFETIME = os.getenv('PAIR_CACHE_LIFETIME', 10)
...
FIXER_ACCESS_KEY = os.getenv('FIXER_ACCESS_KEY', FIXER_ACCESS_KEY)
...
FAST_PAYMENT_TO_RELEASE_TIME_SECONDS = os.getenv(
    'FAST_PAYMENT_TO_RELEASE_TIME_SECONDS', 300)
FAST_CREATE_TO_RELEASE_TIME_SECONDS = os.getenv(
    'FAST_CREATE_TO_RELEASE_TIME_SECONDS', 1200)


# Idenfy settings
IDENFY_VOID_AFTER_MINUTES = os.getenv('IDENFY_VOID_AFTER_MINUTES')