...
RPC_IMPORT_TRANSACTIONS_VALIDATION_COUNT = int(
    get_env_param('RPC_IMPORT_TRANSACTION_VALIDATION_COUNT', 100)
)
...
MINIMUM_BTC_AMOUNT_TO_REFILL_MAIN_ACCOUNT = Decimal('0.5')
