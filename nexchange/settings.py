...
# RPC
RPC_IMPORT_TRANSACTIONS_COUNT = os.getenv('RPC_IMPORT_TRANSACTION_COUNT', 10)
RPC_IMPORT_BLOCK_COUNT = os.getenv('RPC_IMPORT_BLOCK_COUNT', 10)
RPC_GAS_LIMIT_ETH = os.getenv('RPC_GAS_LIMIT_ETH', 30000)
RPC_GAS_LIMIT_TOKEN = os.getenv('RPC_GAS_LIMIT_TOKEN', 70000)
RPC_GAS_PRICE = os.getenv('RPC_GAS_PRICE', 50 * (10 ** 9))
